...
import { getBatch, executeBatch } from '../api/payroll';
...
const PayrollConfirmation: React.FC = () => {
    ...
    const handleExecute = async () => {
        ...
        try {
            ...
            alert('Payroll Batch Executed Successfully!');
            navigate('/payroll');
        } catch (error) {
            console.error('Execution failed:', error);
            alert('Failed to execute payroll batch. Please try again.');
        } finally {
    ...
    if (!batch) return <div className="text-white text-center p-10">Batch not found</div>;
                    ...
                    <div className="flex items-center gap-8">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-medium text-silver-grey">Review</span>
                            </div>
                            <div className="w-8 h-px bg-obsidian-border"></div>
                            <div className="flex items-center gap-2">
                                <span className="w-6 h-6 rounded-full bg-primary text-white text-xs flex items-center justify-center ring-4 ring-primary/20 font-bold">4</span>
                                <span className="text-sm font-bold text-white">Execute</span>
                            </div>
                        </div>
                    ...
                    <div className="w-full lg:w-3/5 space-y-6">
                        <div className="space-y-1">
                            <div className="flex items-center gap-2 text-silver-grey text-sm font-medium">
                                <span>Batch ID: {batch.id.substring(0, 8)}</span>
                            ...
                            <div className="flex items-center group">
                                <input className="text-3xl font-bold bg-transparent border-none p-0 focus:ring-0 w-full text-white" type="text" defaultValue={batch.description || "Untitled Batch"} readOnly />
                                    ...
                                    <div className="grid grid-cols-2 gap-8">
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <p className="text-3xl font-bold text-white">${batch.total_amount} <span className="text-sm font-medium text-silver-grey">{batch.currency}</span></p>
                                            </div>
                                        ...
                                        <div className="space-y-3 bg-obsidian-black/40 p-4 rounded-xl border border-obsidian-border">
                                            <div className="flex justify-between text-sm">
                                                ...
                                                <span className="font-medium text-white">${batch.total_amount}</span>
                                            </div>
                                            <div className="flex justify-between text-sm">
                                            ...
                                            <div className="pt-2 border-t border-obsidian-border flex justify-between font-bold text-white">
                                                ...
                                                <span>${Number(batch.total_amount) + 12.50 + 5.50}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="p-6 space-y-6">
                                    <div className="flex items-center justify-between">
                                        <div className="flex -space-x-3">
                                            ...
                                            <div className="inline-block h-10 w-10 rounded-full ring-2 ring-charcoal bg-obsidian-border"></div>
                                            <div className="inline-block h-10 w-10 rounded-full ring-2 ring-charcoal bg-obsidian-border"></div>
                                            <div className="inline-block h-10 w-10 rounded-full ring-2 ring-charcoal bg-primary/20 flex items-center justify-center text-xs font-bold text-primary">+{batch.recipient_count - 3}</div>
                                        </div>
                                        <div className="text-right">
                                            <p className="text-sm font-bold text-white">{batch.recipient_count} Total Recipients</p>
                                ...
                                <div className="space-y-4">
                                    <div className="flex justify-between items-end">
                                        ...
                                        <div className="text-right">
                                            ...
                                            <p className="text-lg font-bold text-silver-grey">${(125450.23 - Number(batch.total_amount)).toFixed(2)}</p>
                                        </div>
                                    </div>
                            ...
                            <div className="bg-charcoal rounded-xl border border-obsidian-border p-6 shadow-2xl space-y-6">
                                <div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-center gap-3 text-sm">
                                            <span className="material-icons text-emerald-400 text-lg">check_circle</span>
                                            <span className="flex-1 text-white">Admin approval granted</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-normal opacity-80">${batch.total_amount} to {batch.recipient_count} recipients</span>
                                    </button>
                        ...
                        <div className="p-8">
                            ...
                            <div className="bg-primary/5 border border-primary/10 rounded-lg p-6 mb-8 text-center">
                                ...
                                <div className="text-white">
                                    <span className="text-3xl font-bold">${batch.total_amount}</span>
                                </div>
                                <p className="text-primary/60 text-sm mt-1">To be distributed to <span className="text-white font-semibold">{batch.recipient_count} recipients</span></p>
                            </div>

                            {/* 2FA Section using default OTP for now */}
                            <div className="mb-8">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <button
                                    ...
                                    className="px-6 py-3.5 bg-primary text-white font-bold rounded-lg hover:bg-primary/90 transition-all text-sm shadow-lg shadow-primary/20 uppercase tracking-wider flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    <span>{isExecuting ? 'Processing...' : 'Confirm & Execute'}</span>
                                    {!isExecuting && <span className="material-icons text-sm">bolt</span>}
                                </button>
                            </div>
                        </div>
                    </div>
