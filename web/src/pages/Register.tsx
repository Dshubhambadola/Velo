            ...
            <main className="w-full lg:w-[60%] flex items-center justify-center p-6 sm:p-12 bg-velo-dark text-white">
                <div className="w-full max-w-md space-y-8">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <button
                            className="w-full bg-primary hover:bg-primary/90 text-white font-bold py-3.5 px-4 rounded-lg shadow-lg shadow-primary/20 transition-all flex items-center justify-center gap-2 group disabled:opacity-50 disabled:cursor-not-allowed"
                            type="submit"
                            disabled={loading}
                        >
                            {loading ? 'Creating Account...' : 'Create Account'}
                            {!loading && <span className="material-icons text-lg group-hover:translate-x-1 transition-transform">arrow_forward</span>}
                        </button>
                    </form>
